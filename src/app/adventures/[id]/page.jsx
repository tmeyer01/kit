...
function adventure({ params }) {
  return (
    <>
      ...
      <div className="flex flex-col md:flex-row pt-6 m-4">
        ...
        <div className="h-80 md:w-1/2 ml-4 border-red-800 border-2">
          ...
          <p className="p-6">
            Discription of event. Lorem ipsum dolor sit amet consectetur
            adipisicing elit. Fuga repellendus dolor doloribus quaerat nesciunt
            delectus suscipit exercitationem! Mollitia fugiat explicabo nisi
            corporis possimus voluptate voluptas doloribus accusamus cum, sit
            nam?
          </p>
        </div>
      </div>
